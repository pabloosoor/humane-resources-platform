...
public class VacationController {
    ...
    // POST /api/employees/{id}/vacations — registra una solicitud de vacaciones para el empleado
    ...
    // GET /api/employees/{id}/vacations — retorna el historial de vacaciones del empleado
